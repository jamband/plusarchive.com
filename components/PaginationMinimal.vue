  ...
  <nav v-if="hasPage()" aria-label="Page navigation">
    <ul class="pagination">
      ...
      <li class="prev page-item w-25" :class="disabled('prev')">
        <n-link :to="pageLink(pagination.currentPage - 1)" class="page-link text-center" append exact>
          <fa icon="angle-left" />
        </n-link>
      </li>

      <li class="next page-item w-25" :class="disabled('next')">
        <n-link :to="pageLink(pagination.currentPage + 1)" class="page-link text-center" exact>
          <fa icon="angle-right" />
        </n-link>
      </li>

      <li class="last page-item w-25" :class="disabled('last')">
        <n-link :to="pageLink(pagination.pageCount)" class="page-link text-center" exact>
