...
const Page: PageComponent = () => {
  ...
  const createBookmark = useCreateBookmark<Schema>();
  ...
  const onSubmit: SubmitHandler<Schema> = (body) => {
    ...
    createBookmark.mutate(variables, {
  ...
  return (
    <div className={styles.container}>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className={styles.form}>
        ...
        <FormSubmit disabled={form.disabled || createBookmark.isPending}>
          Create
        </FormSubmit>
      </form>
    </div>
...
Page.getLayout = (page) => (
  <AdminLayout title="Create a bookmark">{page}</AdminLayout>
);
